...
//changed
export interface CandyMachine_Gold {
  id: anchor.web3.PublicKey,
  program: anchor.Program;
  state: CandyMachineState_Gold;
}
//changed
interface CandyMachineState_Gold {
...
//THIS IS IMPORTANT, PROBABLY WHERE ALL WORK NEEDS TO BE DONE
//GET 
